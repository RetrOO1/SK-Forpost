    ...
    return(
        <div>
            ...
            <div className="year_of_create">
                <img src="https://sun9-23.userapi.com/impg/qekDu4DPLFlm6dI7RWXMnX31rxXwM3n1y7TGsA/l1xQ_ZxFq8k.jpg?size=604x549&quality=96&sign=8c922c55845ff27665df10d6fed40f73&type=album" alt="" />
            </div>
        </div>
    )
}
